...
{
	private String sex, Mbti, NickName, IPAddress;
	private int Port;
	...
	public void getUserInfo(String sex, String NickName, String Mbti, String IPAddress, int Port) 
	{
	...
	public void run() 
	{
		...
		try {
			...
			out.writeUTF("("+Mbti+") "+NickName+ " ("+sex+")");
			while (in != null) { 
