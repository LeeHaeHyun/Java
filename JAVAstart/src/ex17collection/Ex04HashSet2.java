...
public class Ex04HashSet2
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("hashSet의 크기:"+ hashSet.size()); //3개
		System.out.println();
		
		Teacher t1Same = new Teacher("이정재", 40, "국어");
		Teacher t3Same = new Teacher("관우", 44, "수학");
		/*
		현재 Teacher 클래스는 나이와 과목이 같다면 동일한 객체로 판단하도록
		hashCode(), equals() 메소드가 오버라이딩 되어 있다.
