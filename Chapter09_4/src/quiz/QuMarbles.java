...
//	public ChildProperty() // 디폴드 생성자
//	{
//	}
	
	// 멤버 변수를 초기화 할 목적으로 정의한다.
	public ChildProperty(int bead) // 생성자, 매개변수 1개 있는 생성자 ( 이름 같으면 )
	{
		// this는 멤버변수와 매개변수
	...
	/*
	 구슬게임을 위한 멤버 메소드
	 호출에 주체가 되는 어린이 객체가 인수로 전달된 어린이의 구슬을 
...
public class QuMarbles
{
	...
	{        	
		// 매개변수가 잇는 생성자를 만들었을 때 오류가 난다. 
		// 매개변수가 없는 생성자를 만들어야 오류가 안난다
//		ChildProperty child1 = new ChildProperty(); 
