...
public class ClientThread extends Thread 
{
	...
	private void chCommand(String str) 
	{
		...
		if (!(command[0].equals("도움")) && !(command[0].equals("접")) && !(command[0].equals("랜덤"))
			&& !(command[0].equals("방")) && !(command[0].equals("+")) && !(command[0].equals("입"))
			&& !(command[0].equals("귓")))
		{
