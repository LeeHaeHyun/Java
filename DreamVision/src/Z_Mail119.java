...
public class Z_Mail119 extends Frame
{
	JTextField wfld;
	JTextField pwld;
    ...
    public Z_Mail119()
    {
        ...
        wtLb.setFont(new Font("맑은 고딕", Font.BOLD, 18));
        ...
        powLb.setFont(new Font("맑은 고딕", Font.BOLD, 18));
        ...
        powLb_1.setFont(new Font("맑은 고딕", Font.BOLD, 18));
